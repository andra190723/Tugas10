...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Nov 2023 pada 17.18
...
(1, '1', 'Listrik Token', '2023-11-29 13:06:13', NULL),
(2, '2', 'Listrik Bulanan', '2023-11-29 15:20:19', NULL);
...
(13, 1, '1', 'andra', 'sad', '089636367121', '1234567890', '001', 1, 'Y', 1, '2023-11-29 15:32:12', NULL),
(14, 1, '1', 'amerr', '', '0842342342', '0987654321', '666', 6666, 'Y', 1, '2023-11-29 16:05:43', NULL);
...
(1, 'andra098maulana@gmail.com', '96c859113931a9a21aa2ff72202bdbd0', 'andra', 'ampere', '089636367121', '1', 1, 1, '2023-11-28 12:15:58', NULL);
...
--
ALTER TABLE `tb_pelanggan`
  MODIFY `pel_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
ALTER TABLE `tb_pelanggan`
  ...
  ADD CONSTRAINT `tb_pelanggan_ibfk_2` FOREIGN KEY (`pel_id_user`) REFERENCES `tb_user` (`user_id`);
COMMIT;
